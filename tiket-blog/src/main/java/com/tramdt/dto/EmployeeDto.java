...
public class EmployeeDto {
    ...
    private EmployeeType id_employee_type ;
    ...
    public void setId_Employee_Type(EmployeeType id_employee_type) {
        this.id_employee_type = id_employee_type;
    }

    public EmployeeType getId_employee_type() {
        return id_employee_type;
    }
    ...
    public EmployeeDto(Long id, String name_Employee, String code_Employee, Boolean gender_Employee,
                       String birthday_Employee, String phone_Employee, String email_Employee, String address_Employee, Boolean del_Flag_Employee, EmployeeType id_employee_type) {
        this.id = id;
        this.name_Employee = name_Employee;
        this.code_Employee = code_Employee;
        this.gender_Employee = gender_Employee;
