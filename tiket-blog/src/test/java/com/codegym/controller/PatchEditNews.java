...
public class PatchEditNews {
    ...
    @Test
    public void editNews_code_news()throws Exception{
        ...
        newsDto.setNameNews("Ba con sâuaaaaaaaaa");
    ...
    @Test
    public void editNews_code_news_one()throws Exception{
        NewsDto newsDto = new NewsDto();
        newsDto.setId(null);
    ...
    @Test
    public void editNews_code_news_two()throws Exception{
        NewsDto newsDto = new NewsDto();
        newsDto.setId(null);
        newsDto.setCodeNews("");
        newsDto.setDateNews("");
    ...
    @Test
    public void editNews_code_news_three()throws Exception{
        NewsDto newsDto = new NewsDto();
        newsDto.setId(1L);
